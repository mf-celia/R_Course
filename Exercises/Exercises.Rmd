...
1. Perform the same analses than those carried out in previous exercise 1, using single logistic regression models (i.e. bivariate analyses)
...
5. The file `pulmon.doc` describes a study to investigate which are the most predictive variables of survival in patients dianosed with cancer. Perform the required analysis to answer this scientific question (e.g. Kaplan-Meier, log-rank, Multivariate Cox models).